...
const getServices = (language: "en" | "es") => [
  ...
  {
    title:
      language === "en" ? "Term Life Insurance" : "Seguro de Vida a Término",
    description:
      language === "en"
  ...
  {
    title:
      language === "en" ? "Personal Auto Insurance" : "Seguro de Auto Personal",
    description:
      language === "en"
  ...
  {
    title:
      language === "en" ? "Supplemental Insurance" : "Seguro Suplementario",
    description:
      language === "en"
...
export default function ServicesSection({
  ...
  return (
    <section id="services" className="section-padding relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-gradient-to-br from-white via-primary/5 to-orange-50/30" />
      ...
      <div className="container-custom relative z-10">
        ...
        >
          ...
          <p className="body-text text-primary-700 max-w-3xl mx-auto px-4 sm:px-0">
            {t.subtitle}
          </p>
        </motion.div>
          ...
          {getServices(language).map((service, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`relative ${service.bgColor} p-6 rounded-2xl border border-primary/10 hover:border-orange-300 hover:shadow-2xl transition-all duration-300 h-full`}
                >
                  <motion.div
                  ...
                  <h3 className="text-lg font-bold text-primary-900 mb-2 group-hover:text-orange-600 transition-colors">
                    {service.title}
                  </h3>
          ...
          <Link href="/schedule">
            ...
            >
              {language === "en"
                ...
                : "Obtén tu Cotización Gratis Ahora"}
            </motion.button>
          </Link>
        </motion.div>
      </div>
