    ...
    en: {
      ...
      sections: [
        ...
        },
        {
          ...
          icon: Mail,
          content: `
            <p><a href="mailto:info@unityfinancialnetwork.com" class="text-primary-600 hover:text-primary-700">info@unityfinancialnetwork.com</a> | (786) 963-6392 | 7950 NW 53rd St, STE 136, Doral, FL 33166.</p>
          `
        }
      ]
    },
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <a href="tel:7869636392" className="text-primary-600 hover:text-primary-700 font-semibold">
                        (786) 963-6392
                      </a>
                    </div>
                    <div className="flex items-center gap-3">
