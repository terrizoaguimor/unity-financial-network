      ...
      sections: [
        {
          ...
          content: `
            ...
            <p><strong>Phone:</strong> (786) 963-6392</p>
        ...
        },
        {
          ...
          content: `
            ...
            <p><strong>How to exercise them:</strong> write to <a href="mailto:info@unityfinancialnetwork.com" class="text-primary-600 hover:text-primary-700">info@unityfinancialnetwork.com</a> or call us at (786) 963-6392 (reasonably identifying yourself).</p>
          `
        },
        {
          id: 'marketing',
        ...
        },
        {
          ...
          content: `
            ...
            <p><a href="mailto:info@unityfinancialnetwork.com" class="text-primary-600 hover:text-primary-700">info@unityfinancialnetwork.com</a> | (786) 963-6392</p>
          `
        }
      ]
    },
      ...
      sections: [
        {
          ...
          content: `
            ...
            <p><strong>Teléfono:</strong> (786) 963-6392</p>
            <p><strong>Email:</strong> <a href="mailto:info@unityfinancialnetwork.com" class="text-primary-600 hover:text-primary-700">info@unityfinancialnetwork.com</a></p>
        ...
        },
        {
          ...
          content: `
            ...
            <p><strong>Cómo ejercerlos:</strong> escribe a <a href="mailto:info@unityfinancialnetwork.com" class="text-primary-600 hover:text-primary-700">info@unityfinancialnetwork.com</a> o llámanos al (786) 963-6392 (identificándote razonablemente).</p>
          `
        },
        {
          id: 'marketing',
