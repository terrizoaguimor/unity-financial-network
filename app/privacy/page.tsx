      ...
      sections: [
        {
          ...
          content: `
            ...
            <p><strong>Phone:</strong> ((786) 828-5576</p>
        ...
        },
        {
          ...
          content: `
            ...
            <p><strong>How to exercise them:</strong> write to <a href="mailto:hello@unityfinancialnetwork.com" class="text-primary-600 hover:text-primary-700">hello@unityfinancialnetwork.com</a> or call us at ((786) 828-5576 (reasonably identifying yourself).</p>
          `
        },
        {
          id: 'marketing',
        ...
        },
        {
          ...
          content: `
            ...
            <p><a href="mailto:hello@unityfinancialnetwork.com" class="text-primary-600 hover:text-primary-700">hello@unityfinancialnetwork.com</a> | ((786) 828-5576</p>
          `
        }
      ]
    },
      ...
      sections: [
        {
          ...
          content: `
            ...
            <p><strong>Teléfono:</strong> ((786) 828-5576</p>
            <p><strong>Email:</strong> <a href="mailto:hello@unityfinancialnetwork.com" class="text-primary-600 hover:text-primary-700">hello@unityfinancialnetwork.com</a></p>
        ...
        },
        {
          ...
          content: `
            ...
            <p><strong>Cómo ejercerlos:</strong> escribe a <a href="mailto:hello@unityfinancialnetwork.com" class="text-primary-600 hover:text-primary-700">hello@unityfinancialnetwork.com</a> o llámanos al ((786) 828-5576 (identificándote razonablemente).</p>
          `
        },
        {
          id: 'marketing',
